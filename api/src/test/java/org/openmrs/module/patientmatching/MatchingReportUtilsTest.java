...
public class MatchingReportUtilsTest extends BaseModuleContextSensitiveTest {
    ...
    public void persistIncrementalReportToDB_shouldCreateNewReportAndUpdateReport() throws IOException {
        ...
        Set<Long> matchingPair1 = new HashSet<Long>(Arrays.asList(new Long(2),new Long(6)));
        Set<Long> matchingPair2 = new HashSet<Long>(Arrays.asList(new Long(432),new Long(502)));
        ...
        Set<Long> matchingPair3 = new HashSet<Long>(Arrays.asList(new Long(6),new Long(2)));
        Set<Long> matchingPair4 = new HashSet<Long>(Arrays.asList(new Long(432),new Long(502),new Long(8)));
        ...
        // Two new patient ids have showed a matching property(ids are 2, and 8) with already existing matching pairs in the database
        Set<Long> matchingPair5 = new HashSet<Long>(Arrays.asList(new Long(999),new Long(7)));
